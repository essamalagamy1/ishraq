...
class SeoSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $seoSettings = [
            ...
            [
                'page' => 'home',
                'meta_title' => 'إشراق تك | شركة تصميم وتطوير الحلول البرمجية والمواقع والتطبيقات',
                'meta_description' => 'إشراق تك (Ishraq Tech) - شريكك الرائد في التحول الرقمي وتطوير الحلول البرمجية. نطور مواقع ويب وتطبيقات جوال احترافية بأحدث التقنيات. أكثر من 200 مشروع منجز.',
                'meta_keywords' => 'إشراق,إشراق تك,Ishraq Tech,ishraq.tech,تطوير مواقع,تطبيقات جوال,شركة برمجة,حلول برمجية,تصميم مواقع,React,Laravel,Flutter,تطوير تطبيقات,السعودية,مصر',
                'og_title' => 'إشراق تك | حلول تطوير برمجيات ومواقع وتطبيقات احترافية',
                'og_description' => 'إشراق تك - شريكك في التحول الرقمي، نطور مواقع ويب وتطبيقات جوال احترافية بأحدث التقنيات.',
                'og_type' => 'website',
