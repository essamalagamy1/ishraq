        ...
        <div class="container-page relative z-10">
            <div class="max-w-4xl" data-reveal>
                <div class="flex items-center gap-3 mb-6">
                    <x-ui.eyebrow number="01">{{ __('كتابات وأفكار') }}</x-ui.eyebrow>
                    <span class="w-1.5 h-1.5 rounded-full bg-[color:var(--color-accent)] animate-pulse"></span>
                    <span class="type-eyebrow text-[color:var(--color-accent)]">{{ __('المدونة والمعرفة') }}</span>
                </div>

                <h1 class="type-display mt-6 leading-tight">
                    <span>{{ __('رؤى ومقالات') }}</span>
                    <span class="block text-[color:var(--color-accent)] italic font-serif">{{ __('في التصميم والتقنية وبناء المنتجات.') }}</span>
                </h1>
